...
<footer id="footer" class="container-fluid text-center">
  <div class="row">
    ...
    <div class="col-md-6 col-sm-6 col-lg-4">
      ...
      <div>
        ...
        <div class="footer-icons"> <a href="http://www.findsmiley.dk/527733"><i class="fa fa-smile-o fa-3x" aria-hidden="true"></i></a></div>
          <h6 class="text-muted">Se vores Elite-smiley</h6>
    </div>
    <div class="col-md-6 col-sm-6 col-lg-4">
      <div>
        <h1>Find os her</h1></div>
        <div class="footer-line"></div>
    ...
    <div class="col-md-12 col-sm-12 col-lg-4">
      ...
      <div class="footer-line"></div>
      <div>
        <h4>Mandag-Fredag: 07:30-18:00</h4></div>
      <div>
        <h4 class="p-3">Lørdag: 09:00-18:00</h4></div>
      <div>
        <h4>Søndag: 09:00-17:00</h4></div>
    </div>
    <div class="col">
      <div class="copyrights text-muted">
        <h6>&copy;Copyrights 2017 - Bill's Coffee</h6>
