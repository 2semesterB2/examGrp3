...
<html lang="en">
  <head>
    <title>Bill's Coffee - Kontakt</title>
    <!-- meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Bill's Coffee - kontakt. Kom en tur indenfor. Send en mail. Se vores åbningstider for cafeen. Ris og ros. Kontakt os.">
    <!-- favicon  -->
...
<div class="container-fluid text-center">
  <!-- Google maps Tittel -->
  <div class="title">
  <h1 class="display-4">Kom indenfor hos Bill's Coffee</h1>
    ...
    <form name="sentMessage" id="contactForm" novalidate>
      <div class="control-group">
        <div class="form-group floating-label-form-group controls">
          <input class="form-control" id="name" type="text" placeholder="Navn" required data-validation-required-message="Vær venlig at indtaste et navn.">
          <p class="help-block text-danger"></p>
        </div>
      </div>
      <div class="control-group">
        <div class="form-group floating-label-form-group controls">
          <input class="form-control" id="email" type="email" placeholder="Email Adresse" required data-validation-required-message="Vær venlig at indtaste en email">
          <p class="help-block text-danger"></p>
        </div>
      </div>
      <div class="control-group">
        <div class="form-group floating-label-form-group controls">
          <input class="form-control" id="phone" type="tel" placeholder="Telefon nr">
          <p class="help-block text-danger"></p>
        </div>
      </div>
      <div class="control-group">
        <div class="form-group floating-label-form-group controls">
          <textarea class="form-control" id="message" rows="5" placeholder="Besked" required data-validation-required-message="Vær venlig at skrive en besked"></textarea>
          <p class="help-block text-danger"></p>
        </div>
      </div>
      <br>
...
<div class="col-md-6 col-sm-12 col-lg-6">
  <div>
    <h1>Åbningstider</h1>
    <div class="text-underline"></div>
    <h2 class="p-4">Mandag-Fredag: 07:30-18:00</h2></div>
  <div>
    <h2 class="p-4">Lørdag: 09:00-18:00</h2></div>
  <div>
    <h2 class="p-4">Søndag: 09:00-17:00</h2></div>
</div>
</div>
</section>
